---
title: "Selecting the best group using the Indifference-Zone approach for binomial outcomes"
output:
  # word_document: default
  rmarkdown::html_vignette: default
vignette: >
  %\VignetteIndexEntry{Selecting the best group using the Indifference-Zone approach for binomial outcomes}
...
The indifference-zone approach for binomial outcomes is a statistical method
...
1. What is the probability of correctly selecting the best group in a trial with
   ...
   probability of 90% and the indifference-zone threshold is 10%.
...
2. What is the sample size required per group to achieve 90% power for
   ...
   group has an event probability of 90% and the indifference-zone threshold is
   10%.
...
1. What is the probability that the best group is correctly identified as
   ...
   rate is 80% and the indifference-zone threshold is 10% for all outcomes.
